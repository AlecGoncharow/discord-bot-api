...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.balls_and_wall_wasm = factory();
    }
}( this, function() {
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "balls_and_wall_wasm.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "balls_and_wall_wasm.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'balls_and_wall_wasm'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'balls_and_wall_wasm':", error );
                    throw error;
                });
        }
    }( function() {
